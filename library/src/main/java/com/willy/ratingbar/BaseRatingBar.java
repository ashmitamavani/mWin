    ...
    private void verifyParamsValue() {
        ...
        if (mEmptyDrawable == null) {
            try {
                ...
                e.printStackTrace();
                try {
                    mEmptyDrawable = ResourcesCompat.getDrawable(getResources(), R.drawable.ic_empty, null);
                } catch (Resources.NotFoundException notFoundException) {
                    notFoundException.printStackTrace();
                    try {
                        mEmptyDrawable = getResources().getDrawable(R.drawable.ic_empty,null);
                    } catch (Resources.NotFoundException foundException) {
        ...
        if (mFilledDrawable == null) {
            try {
                ...
                e.printStackTrace();
                try {
                    mFilledDrawable = ResourcesCompat.getDrawable(getResources(), R.drawable.ic_filled, null);
                } catch (Resources.NotFoundException notFoundException) {
                    notFoundException.printStackTrace();
                    try {
                        mFilledDrawable = getResources().getDrawable(R.drawable.ic_filled,null);
                    } catch (Resources.NotFoundException foundException) {
                        foundException.printStackTrace();
                    }
                }
