...
public class ReferPointHistoryFragment extends Fragment {
    ...
    public ReferPointHistoryFragment() {
    }
    ...
    public void onViewCreated(@NonNull View view, @Nullable Bundle savedInstanceState) {
        ...
        rvHistoryList.setAdapter(new EarnedPointHistoryAdapter(listPointHistory, getActivity(), Constants.HistoryType.REFER_POINT));
        ...
        nestedScrollView.setOnScrollChangeListener(new NestedScrollView.OnScrollChangeListener() {
            ...
            public void onScrollChange(NestedScrollView v, int scrollX, int scrollY, int oldScrollX, int oldScrollY) {
                if (scrollY == v.getChildAt(0).getMeasuredHeight() - v.getMeasuredHeight()) {
                    if (pageNo < numOfPage) {
                        new GetEarnedPointHistoryAsync(getActivity(), Constants.HistoryType.REFER_POINT, String.valueOf(pageNo + 1));
                    }
                }
            }
        });
        new GetEarnedPointHistoryAsync(getActivity(), Constants.HistoryType.REFER_POINT, String.valueOf(pageNo));
    }
