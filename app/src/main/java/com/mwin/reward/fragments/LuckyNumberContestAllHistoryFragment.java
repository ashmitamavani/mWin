...
import com.mwin.reward.adapter.LuckyNumberGameAllHistoryAdapter;
...
public class LuckyNumberContestAllHistoryFragment extends Fragment {
    private final List<LuckyNumberAllHistoryItem> listPointHistory = new ArrayList<>();
    private View view;
    ...
    public LuckyNumberContestAllHistoryFragment() {
    }
    ...
    public void onViewCreated(@NonNull View view, @Nullable Bundle savedInstanceState) {
        ...
        rvHistoryList.setAdapter(new LuckyNumberGameAllHistoryAdapter(listPointHistory, getActivity()));
        ...
        nestedScrollView.setOnScrollChangeListener(new NestedScrollView.OnScrollChangeListener() {
            ...
            public void onScrollChange(NestedScrollView v, int scrollX, int scrollY, int oldScrollX, int oldScrollY) {
                if (scrollY == v.getChildAt(0).getMeasuredHeight() - v.getMeasuredHeight()) {
                    if (pageNo < numOfPage) {
                        new GetLuckyNumberGamePointHistoryAsync(getActivity(), Constants.HistoryType.LUCKY_NUMBER_ALL_CONTEST, String.valueOf(pageNo + 1));
                    }
                }
            }
        });
        new GetLuckyNumberGamePointHistoryAsync(getActivity(), Constants.HistoryType.LUCKY_NUMBER_ALL_CONTEST, String.valueOf(pageNo));
    }
