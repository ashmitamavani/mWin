...
import com.mwin.reward.adapter.AdjoeLeaderboardHistoryListAdapter;
import com.mwin.reward.async.GetAdjoeLeaderboardHistoryAsync;
...
public class AdjoeLeaderboardHistoryActivity extends AppCompatActivity {
    ...
    private List<AdjoeLeaderboardHistoryItem> listPointHistory = new ArrayList<>();
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        CommonMethodsUtils.setDayNightTheme(AdjoeLeaderboardHistoryActivity.this);
        ...
        new GetAdjoeLeaderboardHistoryAsync(AdjoeLeaderboardHistoryActivity.this, String.valueOf(pageNo));
        ...
        nestedScrollView.setOnScrollChangeListener(new NestedScrollView.OnScrollChangeListener() {
            ...
            public void onScrollChange(NestedScrollView v, int scrollX, int scrollY, int oldScrollX, int oldScrollY) {
                if (scrollY == v.getChildAt(0).getMeasuredHeight() - v.getMeasuredHeight()) {
                    if (pageNo < numOfPage) {
                        new GetAdjoeLeaderboardHistoryAsync(AdjoeLeaderboardHistoryActivity.this, String.valueOf(pageNo + 1));
                    }
                }
            }
        });
    ...
    public void onBackPressed() {
        try {
            if (responseModel != null && responseModel.getAppLuck() != null ) {
                ...
                CommonMethodsUtils.dialogShowAppLuck(AdjoeLeaderboardHistoryActivity.this, responseModel.getAppLuck());
            } else {
                super.onBackPressed();
            }
        } catch (Exception e) {
    ...
    public void setData(AdjoeLeaderboardResponseModel responseModel1) {
        ...
        if (responseModel.getHistoryData() != null && responseModel.getHistoryData().size() > 0) {
            ...
            if (!isAdLoaded && responseModel.getIsShowInterstitial() != null && responseModel.getIsShowInterstitial().equals(Constants.APPLOVIN_INTERSTITIAL)) {
                AdsUtil.showAppLovinInterstitialAd(AdjoeLeaderboardHistoryActivity.this, null);
                ...
                AdsUtil.showAppLovinRewardedAd(AdjoeLeaderboardHistoryActivity.this, null);
            }
            if (responseModel.getHistoryData() != null && responseModel.getHistoryData().size() > 0) {
            ...
            if (!isAdLoaded) {
                ...
                if (!CommonMethodsUtils.isStringNullOrEmpty(responseMain.getIsShowAppluck()) && responseMain.getIsShowAppluck().equals("1") && !CommonMethodsUtils.isStringNullOrEmpty(responseModel.getIsDefaultAppluck()) && responseModel.getIsDefaultAppluck().equals("1")) {
                    ...
                    CommonMethodsUtils.showDefaultAppLuck(AdjoeLeaderboardHistoryActivity.this, layoutDefaultAd, relMainFlotAppLuck, responseMain.getDefaultAppluckID());
                }
                ...
                try {
                    if (responseModel.getTopAds() != null && !CommonMethodsUtils.isStringNullOrEmpty(responseModel.getTopAds().getImage())) {
                        ...
                        CommonMethodsUtils.loadTopBannerAd(AdjoeLeaderboardHistoryActivity.this, layoutTopAds, responseModel.getTopAds());
                    }
                } catch (Exception e) {
                    e.printStackTrace();
                }
                        ...
                        if (responseModel.getMiniAds() != null) {
                            if (responseModel.getMiniAds().getImage().endsWith(".json")) {
                                ...
                                ivLottieViewMiniAd.setOnClickListener(new View.OnClickListener() {
                                    @Override
                                    public void onClick(View view) {
                                        CommonMethodsUtils.Redirect(AdjoeLeaderboardHistoryActivity.this, responseModel.getMiniAds().getScreenNo(), responseModel.getMiniAds().getTitle(), responseModel.getMiniAds().getUrl(), responseModel.getMiniAds().getId(), responseModel.getMiniAds().getTaskId(), responseModel.getMiniAds().getImage());
                                    }
                                });
        ...
        try {
            if (!listPointHistory.isEmpty() && listPointHistory.size() < 5) {
                ...
                CommonMethodsUtils.loadBannerAds(AdjoeLeaderboardHistoryActivity.this, layoutBannerAdBottom, lblAdSpaceBottom);
            }
        } catch (Exception e) {
            e.printStackTrace();
        }
    ...
    private void loadAppLovinNativeAds() {
        try {
            nativeAdLoader = new MaxNativeAdLoader(CommonMethodsUtils.getRandomAdUnitId(responseMain.getLovinNativeID()), AdjoeLeaderboardHistoryActivity.this);
