...
import com.mwin.reward.async.GetWordSortingDataAsync;
import com.mwin.reward.async.SaveWordSortingAsync;
...
public class WordStoringActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        CommonMethodsUtils.setDayNightTheme(WordStoringActivity.this);
    ...
    private void setViews() {
        ...
        layoutPoints.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                if (SharePreference.getInstance().getBoolean(SharePreference.IS_LOGIN)) {
                    startActivity(new Intent(WordStoringActivity.this, EarnedWalletBalanceActivity.class));
                } else {
                    CommonMethodsUtils.NotifyLogin(WordStoringActivity.this);
                }
            }
        });
        ...
        CommonMethodsUtils.startRoundAnimation(WordStoringActivity.this, ivHistory);
        ivHistory.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                if (SharePreference.getInstance().getBoolean(SharePreference.IS_LOGIN)) {
                    startActivity(new Intent(WordStoringActivity.this, EarnedPointHistoryActivity.class)
                            .putExtra("type", Constants.HistoryType.WORD_SORTING)
                            .putExtra("title", "Word Sorting History"));
                } else {
                    CommonMethodsUtils.NotifyLogin(WordStoringActivity.this);
                }
            }
    ...
    private void loadAppLovinNativeAds() {
        try {
            nativeAdLoader = new MaxNativeAdLoader(CommonMethodsUtils.getRandomAdUnitId(responseMain.getLovinNativeID()), WordStoringActivity.this);
    ...
    private void loadAppLovinNativeAds(FrameLayout frameLayoutNativeAd, TextView lblLoadingAds) {
        try {
            nativeAdLoaderWin = new MaxNativeAdLoader(CommonMethodsUtils.getRandomAdUnitId(responseMain.getLovinNativeID()), WordStoringActivity.this);
    ...
    public void onBackPressed() {
        try {
            if (responseModel != null && responseModel.getAppLuck() != null) {
                ...
                CommonMethodsUtils.dialogShowAppLuck(WordStoringActivity.this, responseModel.getAppLuck());
            } else {
                super.onBackPressed();
            }
        } catch (Exception e) {
    ...
    public void setData(WordSortingResponseModel responseModel1) {
        ...
        try {
            ...
            if (responseModel.getStatus().equals("2")) {
                AdsUtil.showAppLovinInterstitialAd(WordStoringActivity.this, null);
...
//                                    return;
//                                } else {
                                CommonMethodsUtils.Redirect(WordStoringActivity.this, countModel.getScreenNo(), "", "", "", "", "");
//                                }
                            } else if (!CommonMethodsUtils.isStringNullOrEmpty(countModel.getTaskId())) {
                                Intent intent = new Intent(WordStoringActivity.this, TaskInfoActivity.class);
                                intent.putExtra("taskId", countModel.getTaskId());
                                startActivity(intent);
                            } else {
                                Intent intent = new Intent(WordStoringActivity.this, TaskListActivity.class);
                                startActivity(intent);
                            }
                            finish();
                        }
            ...
            if (!CommonMethodsUtils.isStringNullOrEmpty(responseMain.getIsShowAppluck()) && responseMain.getIsShowAppluck().equals("1") && !CommonMethodsUtils.isStringNullOrEmpty(responseModel.getIsDefaultAppluck()) && responseModel.getIsDefaultAppluck().equals("1")) {
                ...
                CommonMethodsUtils.showDefaultAppLuck(WordStoringActivity.this, layoutDefaultAd, relMainFlotAppLuck, responseMain.getDefaultAppluckID());
            }
        } catch (Exception e) {
            e.printStackTrace();
        }
    ...
    private void loadAppLovinNativeAdsTask(LinearLayout layoutAds, FrameLayout frameLayoutNativeAd, TextView lblLoadingAds) {
        try {
            nativeAdLoaderTask = new MaxNativeAdLoader(CommonMethodsUtils.getRandomAdUnitId(responseMain.getLovinNativeID()), WordStoringActivity.this);
            ...
            if (timer == null) {
                timer = new CountDownTimer(Integer.parseInt(countModel.getGameTime()) * 1000L, 1000) {
                    ...
                    public void onFinish() {
                        isFinishGame = true;
                        CommonMethodsUtils.logFirebaseEvent(WordStoringActivity.this, "FeatureUsabilityItemId", "FeatureUsabilityEvent", "Word_Sorting", "Time Over");
    ...
    public void changeCountDataValues(WordSortingResponseModel responseModel) {
        ...
        if (responseModel.getWinningPoints().equals("0")) {
            CommonMethodsUtils.logFirebaseEvent(WordStoringActivity.this, "FeatureUsabilityItemId", "FeatureUsabilityEvent", "Word_Sorting", "Better Luck");
            showBetterluckPopup();
        } else {
            CommonMethodsUtils.logFirebaseEvent(WordStoringActivity.this, "FeatureUsabilityItemId", "FeatureUsabilityEvent", "Word_Sorting", "Word Sorting Got Reward");
    ...
    public void showWinPopup(String point) {
        try {
            ...
            ivClose.setOnClickListener(new View.OnClickListener() {
                @Override
                public void onClick(View view) {
                    AdsUtil.showAppLovinInterstitialAd(WordStoringActivity.this, new AdsUtil.AdShownListener() {
                        @Override
            ...
            dialogWin.setOnDismissListener(new DialogInterface.OnDismissListener() {
                ...
                public void onDismiss(DialogInterface dialogInterface) {
                    CommonMethodsUtils.GetCoinAnimation(WordStoringActivity.this, layoutMain, layoutPoints);
                    tvPoints.setText(SharePreference.getInstance().getEarningPointString());
