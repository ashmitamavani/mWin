...
public class RecyclerViewPagerLoginWA extends RecyclerView {

    private int count;
    private Timer timer = new Timer();
    private PagerAdapterLoginWA adapter;
    ...
    public RecyclerViewPagerLoginWA(@NonNull Context context) {
        super(context);
        initState();
    }


    public RecyclerViewPagerLoginWA(@NonNull Context context, @Nullable AttributeSet attrs) {
    ...
    public RecyclerViewPagerLoginWA(@NonNull Context context, @Nullable AttributeSet attrs, int defStyle) {
    ...
    public void start() {
        try {
            adapter = new PagerAdapterLoginWA(getContext(), pagerModels);
            setAdapter(adapter);
            if (runAuto) {
                if (timer == null)
                    timer = new Timer();
    ...
    public void setOnItemClickListener(PagerAdapterLoginWA.OnItemClickListener itemClickListener) {
        try {

            ((PagerAdapterLoginWA) getAdapter()).setOnclickItemListener(itemClickListener);
