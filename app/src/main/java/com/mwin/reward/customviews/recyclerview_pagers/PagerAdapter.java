...
public class PagerAdapter extends RecyclerView.Adapter<PagerAdapter.ViewHolder> {
    ...
    public PagerAdapter(Context context, List<HomeSliderItem> categorie) {
        this.list = categorie;
    ...
    public ViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        View viewItem = LayoutInflater.from(parent.getContext()).inflate(R.layout.item_home_image_slider, parent, false);
