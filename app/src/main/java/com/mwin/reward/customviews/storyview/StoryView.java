package com.mwin.reward.customviews.storyview;
...
import com.mwin.reward.customviews.storyview.callback.TouchCallbacks;
import com.mwin.reward.customviews.storyview.progress.StoriesProgressView;
import com.mwin.reward.customviews.storyview.utils.PullDismissLayout;
import com.mwin.reward.customviews.storyview.utils.StoryViewHeaderInfo;
import com.mwin.reward.customviews.storyview.utils.ViewPagerAdapter;
...
public class StoryView extends DialogFragment implements StoriesProgressView.StoriesListener,
    ...
    private ArrayList<StoryViewItem> storiesList = new ArrayList<>();
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        return inflater.inflate(R.layout.popup_story, container);
    }
    ...
    private void readArguments() {
        ...
        storiesList = new ArrayList<>((ArrayList<StoryViewItem>) getArguments().getSerializable(IMAGES_KEY));
    ...
    public static class Builder {
        ...
        public Builder setStoriesList(ArrayList<StoryViewItem> storiesList) {
