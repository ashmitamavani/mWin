...
public class NumberSortingResponseModel implements Serializable {
    @Expose
    ...
    @Expose
    private List<NumberSortingItem> data;
    @Expose
    ...
    public List<NumberSortingItem> getData() {
        return data;
    }

    public void setData(List<NumberSortingItem> data) {
        this.data = data;
    }
